...
public class gameMain  {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        gameManager hangman = new gameManager(dictionary2, length, max);
    ...
    public static void playGame(Scanner console, gameManager hangman) {
    ...
    public static void showResults(gameManager hangman) {
